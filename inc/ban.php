        ...
        if(!empty($_SESSION['logged'])){
          ...
          <nav id="menu">
          	<ul>
                ...
                <li><a href="http://techshule.com" target="_NEW">BLOG</a></li>
                <li><a href="./about">ABOUT</a></li>
                <li><a href="mailto:cool@plus256.com?subject=Transform%20my%20Business">CONTACT</a></li>
              </ul>
          </nav>
          <!--Begin Mobile Menu-->
          <nav id="mobile_menu">
              ...
              <div id="mobile_menu_container">
                <div id="menu_drawer_cancel"><?php echo file_get_contents("gra/ic_cancel.svg"); ?></div>
                  <ul>
                    ...
                    <li><a href="http://techshule.com" target="_NEW">BLOG</a></li>
                    <li><a href="./about">ABOUT</a></li>
                    <li><a href="mailto:stream@plus256.com?subject=Transform%20my%20Business">CONTACT</a></li>
                  </ul>
                  <div class="spacer"></div>
              </div>
              <div class="spacer"></div>
